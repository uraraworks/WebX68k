...
WebX68kのHostFSはこの読み方に基づき、空き約1GBでどの欄もワード(0-65535)に収まる
値を返す: 使用可能クラスタ32000・総クラスタ65535・クラスタあたり64セクタ・
セクタあたり512バイト(クラスタ=32768B)。総バイト数=65535×32768=2,147,450,880B、
使用可能バイト数(+18)=32000×32768=1,048,576,000B(≒1,024,000K)。XM6等の他実装は
